...
However, I noticed one weird issue with yarn when it came to globally installing packages that I hadn't been able to figure out and thus always used npm to install global packages or
